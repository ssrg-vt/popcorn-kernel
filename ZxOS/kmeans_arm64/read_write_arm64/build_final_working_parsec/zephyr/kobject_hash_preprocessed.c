...
#line 19 "kobject_hash.gperf"
    {"X\201\004\240\000\000\000\000", {}, K_OBJ_THREAD, 0, { .thread_id = 1 }},
#line 16 "kobject_hash.gperf"
    {"\2200\002\240\000\000\000\000", {}, K_OBJ_DRIVER_UART, 0 | K_OBJ_FLAG_DRIVER, { .unused = 0 }},
#line 21 "kobject_hash.gperf"
    {"\000\220\011\240\000\000\000\000", {}, K_OBJ_THREAD_STACK_ELEMENT, 0, { .stack_size = 8192 }},
#line 20 "kobject_hash.gperf"
    {"\0000\011\240\000\000\000\000", {}, K_OBJ_THREAD_STACK_ELEMENT, 0, { .stack_size = 24576 }},
#line 18 "kobject_hash.gperf"
    {" \200\004\240\000\000\000\000", {}, K_OBJ_THREAD, 0, { .thread_id = 0 }},
#line 17 "kobject_hash.gperf"
    {"\030`\002\240\000\000\000\000", {}, K_OBJ_SYS_MUTEX, 0, { .mutex = &kernel_mutexes[0] }}
  };
...
#endif
struct z_object *
z_object_lookup (register const char *str, register unsigned int len)
{
