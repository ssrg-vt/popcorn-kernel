...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KERNEL_VM_SIZE, 0x10000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QEMU_UEFI_BOOT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 204800);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUILD_OUTPUT_EFI, 1);
