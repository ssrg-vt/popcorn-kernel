...
const int redirect_table[] = {__NR_socket, __NR_clock_gettime, __NR_setsockopt,
  __NR_bind, __NR_listen, __NR_accept4, __NR_shutdown, __NR_recvfrom,
  __NR_epoll_create1 , -1/*__NR_epoll_waiti*/, __NR_epoll_pwait,
  __NR_epoll_ctl, __NR_read, __NR_write, -1/* __NR_open*/, __NR_close,
  __NR_ioctl, __NR_writev, __NR_fstat, __NR_sendfile, -1 /*__NR_select*/,
  __NR_fcntl, -1 /* __NR_stat*/, __NR_getpid, __NR_getuid, __NR_dup,
  __NR_openat, __NR_gettimeofday, __NR_statx, __NR_pselect6  } ;
