...
/*
 * /drivers/msg_layer/ring_buffer.c
 *
 * Original file developed by SSRG Virgnia Tech
 *
...
static int __init_ring_buffer(struct ring_buffer *rb, const unsigned short nr_chunks,
...
static inline void __set_header(struct ring_buffer_header *header, bool reclaim,
				size_t size)
{
...
static inline bool __get_next_chunk(struct ring_buffer *rb,
