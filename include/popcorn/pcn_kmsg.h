...
enum pcn_kmsg_type {
	...
	PCN_KMSG_TYPE_PROC_SRV_NEW_KERNEL_RESPONSE,
	...
	PCN_KMSG_TYPE_PCN_PERF_START,
	PCN_KMSG_TYPE_PCN_PERF_END,
	PCN_KMSG_TYPE_PCN_PERF_CONTEXT,
	PCN_KMSG_TYPE_PCN_PERF_ENTRY,
	PCN_KMSG_TYPE_PCN_PERF_END_ACK,
